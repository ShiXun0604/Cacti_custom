...
if (!isset($called_by_script_server)) {
	...
	print call_user_func_array('ss_datacore_Mirroring', $_SERVER['argv']);
} else {
	include_once(dirname(__FILE__) . '/../lib/snmp.php');
}

function ss_datacore_Mirroring($hostname = '', $host_id = 0, $snmp_auth = '', $cmd = 'index', $arg1 = '', $arg2 = '') {
    ...
    $table = $datacore_config->monitTarget->mirroring->tableName;
